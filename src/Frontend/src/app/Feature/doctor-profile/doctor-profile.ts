...
export class DoctorProfile implements OnInit {
  ...
  // Message to display after booking or other actions
  message: string = '';
  ...
  /**
   * Gets the time slots for the currently selected date.
   * @returns An array of AppointmentSlot for the selected date, or an empty array if no date is selected.
   */
  getSlotsForSelectedDate(): TimeSlotsWithStatusDTO[] {
    ...
    // console.log(dateString,this.selectedDate);
    return this.dateSlotsMap[dateString] || [];
  }

  /**
   * Handles the booking of a specific time slot.
   * @param slot The AppointmentSlot object to book.
   */
  //-------- TO BE CONTINUEED
