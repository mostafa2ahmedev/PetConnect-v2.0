...
import { IDoctorEdit } from '../Doctor/doctor-edit-profile/idoctor-edit';
...
export class DoctorsService {
  ...
  getById(id: string): Observable<IDoctor | string> {
    return this.httpClient.get<IDoctor | string>(
      `https://localhost:7102/api/Doctors/${id}`
    );
  }
  editByIdWithFile(id: string, doctor: IDoctorEdit): Observable<any> {
